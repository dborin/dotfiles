...
let colors_name = "dborin_vividchalk"
...
hi ModeMsg          guifg=black       guibg=#C6C5FE     gui=BOLD      ctermfg=black       ctermbg=yellow      cterm=BOLD
...
highlight LineNr        guifg=#3D3D3D guibg=black gui=NONE ctermfg=yellow ctermbg=darkgray cterm=NONE
...
call s:hibg("VisualNOS" ,"#444444","LightBlue",81)
"call s:hibg("MatchParen","#FF0000","Red",124)
hi MatchParen           guifg=#f6f3e8 guibg=#857b6f gui=BOLD ctermfg=darkblue ctermbg=cyan cterm=bold
...
"call s:hifg("Comment"        ,"#9933CC","Grey",59) " 92
